...
from topology.kube import KubernetesConfigMapGenerator
...
DEFAULT_KUBECFG_FILE = "kubeconfig.yaml"
DEFAULT_KUBE_NAMESPACE = "scion"
...
class ConfigGenerator(object):
    ...
    def generate_all(self):
        ...
        if self.args.kube_push_config:
            k = KubernetesConfigMapGenerator(self.args)
            k.generate_configmaps(topo_dicts)
