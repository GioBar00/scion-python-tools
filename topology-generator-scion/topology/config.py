...
DEFAULT_TOPOLOGY_FILE = "default.topo"
...
class ConfigGenerator(object):
    ...
    def __init__(self, args):
        ...
        """
        self.args = args
        if self.args.topo_config and not self.args.skip_parsing:
            with open(self.args.topo_config) as f:
                self.topo_config = yaml.load(f, Loader=yaml.SafeLoader)
        elif self.args.topo_config_preloaded and self.args.skip_parsing:
            self.topo_config = self.args.topo_config_preloaded
